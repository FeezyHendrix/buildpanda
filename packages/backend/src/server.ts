...
import adminInspectionCategoryRoutes from "./modules/inspection-categories/admin-routes.ts";
import inspectionRoutes from "./modules/inspections/routes.ts";
import adminInspectionRoutes from "./modules/inspections/admin-routes.ts";
...
import activityReferencesRoutes from "./modules/activities/references-routes.ts";
...
import invoicePaymentRoutes from "./modules/invoices/payment-routes.ts";
...
import proposalEstimateRoutes from "./modules/proposals/estimate-routes.ts";
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  await app.register(adminInspectionCategoryRoutes);
  await app.register(inspectionRoutes);
  await app.register(adminInspectionRoutes);
  ...
  await app.register(activityReferencesRoutes);
  await app.register(dailyLogRoutes);
  await app.register(teamMemberRoutes);
  await app.register(invoicePaymentRoutes);
  ...
  await app.register(proposalEstimateRoutes);
