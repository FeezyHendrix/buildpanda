...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex("material_procurements").insert([
    { id: "mp1", project_id: PROJECT_ID, material_order_id: null, name: "16mm Reinforcement Steel (120 lengths)", purchased_at: "11-04-2026, 11:12 AM", receipt: "reciept_INV-4029.jpeg", amount: 3_420_000, thumbnail_tone: "brand", sort_order: 0 },
    { id: "mp2", project_id: PROJECT_ID, material_order_id: null, name: "Dangote Grade 42.5 Cement (200 bags)", purchased_at: "10-04-2026, 11:12 AM", receipt: "reciept_INV-4028.jpeg", amount: 900_000, thumbnail_tone: "amber", sort_order: 1 },
    { id: "mp3", project_id: PROJECT_ID, material_order_id: null, name: "Sandcrete blocks 9-inch (1,500 blocks)", purchased_at: "08-04-2026, 9:30 AM", receipt: "reciept_INV-4024.jpeg", amount: 720_000, thumbnail_tone: "orange", sort_order: 2 },
    { id: "mp4", project_id: PROJECT_ID, material_order_id: null, name: "Sharp sand (40 tonnes)", purchased_at: "06-04-2026, 2:45 PM", receipt: "reciept_INV-4021.jpeg", amount: 480_000, thumbnail_tone: "gray", sort_order: 3 },
    { id: "mp5", project_id: PROJECT_ID, material_order_id: null, name: "Granite chippings 3/4 (25 tonnes)", purchased_at: "05-04-2026, 10:15 AM", receipt: "reciept_INV-4019.jpeg", amount: 550_000, thumbnail_tone: "gray", sort_order: 4 },
    { id: "mp6", project_id: PROJECT_ID, material_order_id: null, name: "12mm Reinforcement Steel (200 lengths)", purchased_at: "04-04-2026, 8:20 AM", receipt: "reciept_INV-4017.jpeg", amount: 4_400_000, thumbnail_tone: "brand", sort_order: 5 },
    { id: "mp7", project_id: PROJECT_ID, material_order_id: null, name: "Binding wire 16 gauge (20 rolls)", purchased_at: "03-04-2026, 4:00 PM", receipt: "reciept_INV-4015.jpeg", amount: 170_000, thumbnail_tone: "amber", sort_order: 6 },
  ]);

  await knex("milestone_payments").insert([
    { id: "m1", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, name: "Mobilisation & site setup", phase: "Preliminaries", status: "Completed", percent_complete: 100, amount: 6_000_000, proof_file_name: "mobilisation_signoff.pdf", proof_verified: true, inspector_sign_off: "Verified", sort_order: 0 },
    { id: "m2", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, name: "Substructure & foundations", phase: "Foundation", status: "Completed", percent_complete: 100, amount: 9_500_000, proof_file_name: "substructure_certificate.pdf", proof_verified: true, inspector_sign_off: "Verified", sort_order: 1 },
    { id: "m3", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, name: "Ground floor slab & columns", phase: "Structural Shell", status: "InProgress", percent_complete: 65, amount: 14_500_000, proof_file_name: null, proof_verified: false, inspector_sign_off: "Scheduled", sort_order: 2 },
    { id: "m4", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, name: "First floor slab & columns", phase: "Structural Shell", status: "Pending", percent_complete: 0, amount: 14_500_000, proof_file_name: null, proof_verified: false, inspector_sign_off: "Pending", sort_order: 3 },
    { id: "m5", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, name: "Roof structure & sheeting", phase: "Roofing", status: "Pending", percent_complete: 0, amount: 12_800_000, proof_file_name: null, proof_verified: false, inspector_sign_off: "Pending", sort_order: 4 },
    { id: "m6", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, name: "First fix M&E", phase: "MEP", status: "Pending", percent_complete: 0, amount: 8_800_000, proof_file_name: null, proof_verified: false, inspector_sign_off: "Pending", sort_order: 5 },
    { id: "m7", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, name: "Second fix M&E & finishes", phase: "MEP", status: "Pending", percent_complete: 0, amount: 11_200_000, proof_file_name: null, proof_verified: false, inspector_sign_off: "Pending", sort_order: 6 },
    { id: "m8", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, name: "Practical completion", phase: "Completion", status: "Pending", percent_complete: 0, amount: 6_500_000, proof_file_name: null, proof_verified: false, inspector_sign_off: "Pending", sort_order: 7 },
  ]);

  await knex("payment_ledger").insert([
    { id: "l1", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, entry_date: "20-06-2026", description: "Release · Ground floor slab (interim, 65%)", amount: 5_800_000, type: "Release", sort_order: 0 },
    { id: "l2", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, entry_date: "05-05-2026", description: "Release · Substructure & foundations", amount: 9_500_000, type: "Release", sort_order: 1 },
    { id: "l3", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, entry_date: "10-04-2026", description: "Release · Mobilisation", amount: 6_000_000, type: "Release", sort_order: 2 },
    { id: "l4", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, entry_date: "01-04-2026", description: "Deposit · Second tranche funding", amount: 30_000_000, type: "Deposit", sort_order: 3 },
    { id: "l5", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, entry_date: "15-03-2026", description: "Deposit · Advance payment (10% mobilisation)", amount: 12_000_000, type: "Deposit", sort_order: 4 },
    { id: "l6", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, entry_date: "01-03-2026", description: "Deposit · Initial project funding", amount: 25_000_000, type: "Deposit", sort_order: 5 },
    { id: "l7", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, entry_date: "05-05-2026", description: "Hold · Retention accrued (5% of substructure)", amount: 475_000, type: "Hold", sort_order: 6 },
    { id: "l8", project_id: PROJECT_ID, building_id: SHARED_BUILDING_ID, entry_date: "20-06-2026", description: "Hold · Retention accrued (5% of ground floor interim)", amount: 305_000, type: "Hold", sort_order: 7 },
  ]);
