  ...
  return (
    <div className="flex flex-col max-w-xl mx-auto mt-8 gap-8">
      <div className="text-center">
        <h2 className="text-2xl font-semibold text-ink mb-2">Upload Drawings</h2>
        <p className="text-ink-muted">Optional. Upload PDF or CAD files to store them in your project's document register.</p>
        <p className="text-sm text-ink-muted mt-2">Note: CAD files (.dwg, .dxf) are stored safely but are not previewable in the browser.</p>
      </div>
      ...
      {successCount > 0 && !uploading && (
        <div className="flex flex-col items-center p-6 text-center">
          ...
          <p className="text-ink-muted mt-2">Successfully uploaded {successCount} drawing(s).</p>
        </div>
      )}
        ...
        >
          {uploading ? (
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-sm font-medium text-ink">Uploading drawings...</span>
            </div>
          ) : (
            <>
              ...
              <p className="mb-4 text-xs text-ink-muted">.pdf, .dwg, or .dxf files</p>
      ...
      {errorMsg && <p className="text-sm text-negative-500 text-center">{errorMsg}</p>}
    </div>
  );
}
