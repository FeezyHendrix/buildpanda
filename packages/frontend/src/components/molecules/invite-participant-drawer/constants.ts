...
export const ROLE_META: Record<KnownParticipantRole, { label: string; description: string }> = {
  client: {
    label: "Client",
    description:
      "Views progress, raises RFIs and approves milestone payments. Finance details hidden by default.",
  },
  project_manager: {
    label: "Project Manager",
    description:
      "Runs the project day to day: manages schedule, tasks, RFIs, materials and compliance. Cannot approve payments or manage participants.",
  },
  architect: {
    label: "Architect",
    description:
