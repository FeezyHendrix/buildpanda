...
export function InputBar({
  ...
  return (
    <div className="shrink-0 border-t border-line-hair bg-white p-4">
      {error && (
      ...
      <div className="relative flex items-end rounded-xl border border-line-hair bg-surface-alt p-1 focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-primary-500">
        <textarea
          value={input}
        ...
        <div className="absolute bottom-2 right-2">
          {streaming ? (
            ...
            <button
              onClick={onSend}
              disabled={!input.trim()}
              className="flex size-8 items-center justify-center rounded-lg bg-primary-500 text-white transition-colors hover:bg-primary-600 disabled:opacity-50 disabled:hover:bg-primary-500"
            >
