...
export function BlendComparisonPanel({
  ...
  return (
            <div className="z-30 w-full border-t border-line-hair bg-white p-3 md:absolute md:bottom-4 md:left-1/2 md:w-[560px] md:max-w-[calc(100%-2rem)] md:-translate-x-1/2 md:rounded-lg md:border md:border-line md:shadow-card">
              <div className="flex items-center gap-2">
                <div className="flex rounded-lg border border-line-hair bg-surface-alt p-0.5" role="group" aria-label="Blend mode">
                ...
                <Button variant="secondary" size="sm" onClick={onOpenSplit}>
              ...
              <div className="mt-3 flex items-center justify-between gap-2 text-xs">
                ...
                <button
                  type="button"
                  onClick={onReset}
                  className="rounded-md px-2 py-1 font-medium text-primary-600 hover:bg-surface-alt"
                >
                  Reset
                </button>
              </div>
