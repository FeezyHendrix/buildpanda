...
export function LegalPage({ doc }: { doc: LegalDocument }) {
  return (
    <div className="min-h-dvh bg-surface-alt">
      <header className="sticky top-0 z-10 border-b border-line-hair bg-white/90 backdrop-blur">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12 sm:py-16">
        <h1 className="text-3xl font-medium tracking-tight text-gray-900 sm:text-4xl">{doc.title}</h1>
        ...
        <div className="mt-14 flex flex-wrap gap-x-6 gap-y-2 border-t border-line-hair pt-6 text-sm">
