...
const SECTION_BY_EXACT_TYPE: Record<string, string> = {
  ...
  milestone_released: "finances/billing?tab=stage-payments",
  milestone_disputed: "finances/billing?tab=stage-payments",
...
const SECTION_BY_PREFIX: Array<[string, string]> = [
  ...
  ["milestone", "finances/billing?tab=stage-payments"],
  ["document", "documents"],
