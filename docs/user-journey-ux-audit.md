...
Verification below records checks completed before the test suites and generated benchmark fixtures were removed from the repository at the user’s request.
